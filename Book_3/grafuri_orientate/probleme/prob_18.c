/* n persoane - > fiecare declara daca cunoaste sau nu celelalte persoane din grup
program care det care este pers cea mai cunoscuta din grup
*/
...
int main()
{
    ...
    printf("persoana cea mai cunoscuta de celelalte este: \n");
