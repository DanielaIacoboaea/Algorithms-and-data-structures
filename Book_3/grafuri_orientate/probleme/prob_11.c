/* graf orientat;
o succesiune de varfuri, sa se decida daca este drum -> daca da, sa se afiseze daca este drum elementar sau nu
...
int main()
{
    ...
    if (track[y] == 0)
    {
        ...
        printf("drumul de la %d la %d trece prin nodurile: \n", x, y);
        print_path(track, y);
        printf("%d ", y);
        printf("\n");
    }
